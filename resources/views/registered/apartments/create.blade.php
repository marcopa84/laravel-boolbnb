...
<form action="{{route('registered.apartments.store')}}" method="POST" enctype="multipart/form-data">
   ...
   <div class="form-group">
      ...
      <input class="form-control" type="number" min="1" name="rooms_number" id="rooms_number" placeholder="Inserisci il numero stanze disponibili" value="{{ old('rooms_number') }}">
   ...
   <div class="form-group">
      ...
      <input class="form-control" type="number" min="1" name="beds_number" id="beds_number" placeholder="Inserisci il numero letti disponibili" value="{{ old('beds_number') }}">
   ...
   <div class="form-group">
      ...
      <input class="form-control" type="number" min="1" name="bathrooms_number" id="bathrooms_number" placeholder="Inserisci il numero bagni disponibili"  value="{{ old('bathrooms_number') }}">
   ...
   <div class="form-group">
      ...
      <input class="form-control" type="number" min="1" name="size" id="size" placeholder="Inserisci la grandezza dell'appartamento" value="{{ old('size') }}">
      @if($errors->has('size'))
   ...
   <div class="form-group" id="address-form-group">
      ...
      <input class="form-control" type="number" name="number" min="1" id="number" placeholder="Inserisci il Civico" value="{{ old('number') }}">
   ...
   <div class="form-group">
      ...
      <input class="form-control" type="number" min="1" step="0.1" name="price" id="price" placeholder="Inserisci il prezzo per notte" value="{{ old('price') }}">
      @if($errors->has('price'))
   ...
   <div class="form-group">
      ...
      <input type="radio" name="visible" value="0" id="nopublished" {{ (old('visible') == '0') ? 'checked' : '' }}>
      <label for="published">Pubblicato</label>
      <input type="radio" name="visible" value="1" id="published" {{ (old('visible') == '1') ? 'checked' : '' }}>
